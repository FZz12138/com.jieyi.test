...
//		dataMap.put("memopenid", "1234567890");//
		dataMap.put("idtype", "01");//
		dataMap.put("idno", "123456200101011122");//
		dataMap.put("custname", "张三");//
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER35002 + "/yktcorefront/account/openYktAcc/V1",
				gson.toJson(map));
