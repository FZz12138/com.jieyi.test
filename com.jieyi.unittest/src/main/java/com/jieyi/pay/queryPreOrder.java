...
public class queryPreOrder {
	...
	public static void main(String[] args) throws Exception {
		...
		dataMap.put("orderid", "0913104156-1110");//
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_LOCALHEADER35001 + "/pay/order/queryPreOrder/V1",
				gson.toJson(map));
