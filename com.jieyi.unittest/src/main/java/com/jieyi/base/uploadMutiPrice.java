...
*/
		...
		Map<String, Object> datamap = new HashMap<String, Object>();
		datamap.put("stationdirection", "1");
		datamap.put("startstationid", "站台001");
		datamap.put("endstationid", "站台009");
		datamap.put("price", "222.2222");
		pricelist.add(datamap);
		Map<String, Object> datamap1 = new HashMap<String, Object>();
		datamap1.put("stationdirection", "0");
		datamap1.put("startstationid", "站台009");
		datamap1.put("endstationid", "站台079");
		datamap1.put("price", "222.2222");
		pricelist.add(datamap1);
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER31000 + "/base/mutiprice/uploadMutiPrice/V1",
				gson.toJson(map));
