...
public class uploadSignal {
	public static void main(String[] args) throws Exception {
		...
		dataMap.put("mchntid", "1001");// 
		dataMap.put("termid", "11112222");//
		dataMap.put("termseq", "20181119");// 
		dataMap.put("driverid", "233");// 
		dataMap.put("sellerid", "332");// 
		dataMap.put("buslineid", "11");// 
		dataMap.put("busstationid", "09");// 
		dataMap.put("busdirection", "0");// 
		dataMap.put("busno", "98765");// 
		dataMap.put("buslongitude", "999");// 
		dataMap.put("buslatitude", "8889");// 
		dataMap.put("signaldate", DateUtil.getSystemDateTime("yyyyMMdd"));// 
		dataMap.put("signaltime", DateUtil.getSystemDateTime("HHmmss"));// 
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER31000 + "/qrcode/signal/uploadSignal/V1",
				gson.toJson(map));
