...
public class TestCRC {
	public static void main(String[] args) throws Exception {
		String xxx = "222233445566778899001122334455667780";
		//String xxx = "1122";

//		System.out.println(calCRC(xxx));
//		System.out.println(getCRC(xxx));
		
		System.out.println(Crc(StringUtil.hexStringToBytes(xxx),xxx.length()/2));
		
		
		String yyy = "00998877665544332211";
		System.out.println(Crc(StringUtil.hexStringToBytes(yyy),yyy.length()/2));
	}

	// private static int calCRC(String data) {
	// // CRC的初始值为0xFFFF
	// int crc = 0;
	// crc &= 0xFF;
	// crc <<= 4;
	...
	// for (int l = 0; l < dataByte.length; l++) {
	// crc = (byte) (crc ^ (dataByte[l] << 8));
	// for (int i = 0; i < 8; i++) {
	// if ((crc & 0x8000) == 1) {
	...
	static final char[] crc_tb = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084,
...
//	static char Crc(byte[] Source, int len) {
//
//		char crc;
//		byte da;
//		crc = 0x0;
...
//	}
	...
	static int Crc(byte[] Source, int len) {
