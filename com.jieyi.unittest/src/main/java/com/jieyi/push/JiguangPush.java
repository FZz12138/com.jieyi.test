...
public class JiguangPush {
	public static void main(String[] args) throws Exception {
		...
		dataMap.put("pushtype", "1");// 根据memopenid来查询
		dataMap.put("memopenid", "20180920105511311FP14215845LNT1C");// 根据memopenid来查询
		dataMap.put("msgtype", "M001");//
		
		Map<String, Object> msgcontent = new HashMap<String, Object>();
		msgcontent.put("accno", "11111111");
		msgcontent.put("amtaft", "9000");
		msgcontent.put("txmamt", "1000");
		msgcontent.put("amtbef", "10000");
		msgcontent.put("txndate", "20180928");
		msgcontent.put("txntime", "121212");
		dataMap.put("msgcontent", msgcontent);
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER45001 + "/msgpush/jiguang/sendPush/V1",
				gson.toJson(map));
