...
//		dataMap.put("loginpasswd", "66");
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER31002 + "/account/recharge/V1",
				gson.toJson(map));
