...
public class ConsumeNoPasswd {
	public static void main(String[] args) throws Exception {		
		...
		dataMap.put("memopenid", "20180919170928629Y1323T8UF2W2A0U");
		dataMap.put("accno", "20180919170928665530");
		dataMap.put("txnamt", "100");
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER31002 + "/account/consume/consumeNoPasswd/V1",
				gson.toJson(map));
