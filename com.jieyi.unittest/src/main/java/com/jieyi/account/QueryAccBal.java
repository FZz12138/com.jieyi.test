...
public class QueryAccBal {
	public static void main(String[] args) throws Exception {		
		...
		dataMap.put("certifylevel", "1");
		dataMap.put("custname", "555555");
		dataMap.put("idtype", "01");
		dataMap.put("idno", "10000000011");
		dataMap.put("mobilephone", "15151818731");
		dataMap.put("verifycodeusage", "2");
		dataMap.put("authcode", "1");
		dataMap.put("accno", "80181226000000021927");
		dataMap.put("cardno", "3104831599900000273");
		dataMap.put("isscardinstid", "676767676");
		dataMap.put("loginpasswd", "66");
		dataMap.put("passwdtype", "0");
		dataMap.put("authcode", "000111");
		dataMap.put("verifycode", "111111");
		dataMap.put("registerflag", "0");
		dataMap.put("memopenid", "10000000011"); 
		...
		String strRet = HttpClientUtil.httpPostJson(Consts.URL_HEADER45001 + "/yktcoreservicefront/account/getAvailableBalance/V1",
				gson.toJson(map));
